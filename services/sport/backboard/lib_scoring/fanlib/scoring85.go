...
const (
	_SCORING_85_ID     = 85
	_SCORING_85_NAME   = "软缺"
	_SCORING_85_FANSHU = 6
)

var _SCORING_85_CHECKID_ = []int{84} //和软缺不能共存
//自己注册
func init() {
	// fmt.Println("84")
	G_ScoringManager.RegisterBaseHander(&scoring_85{
		id:           _SCORING_85_ID,
		name:         _SCORING_85_NAME,
		fanShu:       _SCORING_85_FANSHU,
		setDiscardID: _SCORING_85_CHECKID_,
		huKind:       scoringlib2.SCORING_SPECIAL,
		humask:       scoringlib2.CANBE_CHIHU,
	})
}

type scoring_85 struct {
	id           int
	name         string
	fanShu       int
	setDiscardID []int
...
func (this *scoring_85) GetID() int {
	return this.id
}

func (this *scoring_85) Name() string {
	return this.name
}

func (this *scoring_85) GetFanShu() int {
	return this.fanShu
}
func (this *scoring_85) GethuKind() int {
	return this.huKind
}

//不能直接用这个就结束
func (this *scoring_85) CheckSatisfySelf(handInfoCtx *cardmgr2.CheckHuCTX) bool {
...
//将将胡能胡硬的，优先硬的
func (this *scoring_85) SpircalProcess(handInfoCtx *cardmgr2.CheckHuCTX) (uint64, byte, []int) {
...
func (this *scoring_85) Check_base(cbCardIndex []byte, weaveItem []static.TagWeaveItem) (result bool) {
...
//查花色，没问题
func (this *scoring_85) Check_Normal(cbCardIndex []byte, weaveItem []static.TagWeaveItem, checkCard byte, isNormalCard bool, guiCards []byte) (result uint64, needgodNum byte, err error) {
